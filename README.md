...
8) Доработать структуры ответов

### Стоит улучшить, доработать
1) ```internal/pkg/types/types.go``` - Поменять валидацию полей(усл.:backend_junior разбивать на 2 части, валидировать по отдельности)